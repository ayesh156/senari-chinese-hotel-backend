...
async function main() {
  ...
  // ── Food Categories (Synchronized with PDF Menu Categories) ───────────────
 ...
 // ── Food Items (Extracted strictly with exact menu headers) ────────────────
  const foodItemsData = [
    // ── Teas ──────────────────────────────────────────────────────────────────
    {
      name: 'Ice Tea',
    ...
    // ── Cool Drinks ───────────────────────────────────────────────────────────
    { name: 'Coca Cola 400ml', category: 'Cool Drinks', description: 'Chilled Coca Cola 400ml bottle', ingredients: ['Coca Cola'] },
    { name: 'Zero Coca Cola 400ml', category: 'Cool Drinks', description: 'Zero sugar Coca Cola 400ml', ingredients: ['Zero Coca Cola'] },
    { name: 'Coca Cola 300ml', category: 'Cool Drinks', description: 'Chilled Coca Cola 300ml glass bottle', ingredients: ['Coca Cola'] },
    { name: 'Sprite 400ml', category: 'Cool Drinks', description: 'Refreshing lemon-lime Sprite 400ml', ingredients: ['Sprite'] },
    { name: 'Sprite 300ml', category: 'Cool Drinks', description: 'Chilled Sprite 300ml glass bottle', ingredients: ['Sprite'] },
    { name: 'Lemonade 400ml', category: 'Cool Drinks', description: 'Fizzy sweet and sour Lemonade 400ml', ingredients: ['Lemonade'] },
    { name: 'Soda 500ml', category: 'Cool Drinks', description: 'Carbonated soda water 500ml', ingredients: ['Soda'] },
    { name: 'Soda 400ml', category: 'Cool Drinks', description: 'Carbonated soda water 400ml', ingredients: ['Soda'] },
    { name: 'Tonic 500ml', category: 'Cool Drinks', description: 'Classic tonic water 500ml', ingredients: ['Tonic water'] },
    { name: 'Tonic 400ml', category: 'Cool Drinks', description: 'Classic tonic water 400ml', ingredients: ['Tonic water'] },
    { name: 'Dry Ginger Ale 400ml', category: 'Cool Drinks', description: 'Crisp dry ginger ale 400ml', ingredients: ['Ginger ale'] },
    { name: 'Ginger Beer 400ml', category: 'Cool Drinks', description: 'Spicy Sri Lankan ginger beer 400ml', ingredients: ['Ginger beer'] },
    { name: 'Water 1L', category: 'Cool Drinks', description: 'Purified drinking water 1 Litre bottle', ingredients: ['Mineral water'] },
    { name: 'Water 500ml', category: 'Cool Drinks', description: 'Purified drinking water 500ml bottle', ingredients: ['Mineral water'] },
    ...
    // ── Pasta ─────────────────────────────────────────────────────────────────
    { name: 'Penne Arrabbiata Chicken', category: 'Pasta', description: 'Penne pasta tossed in spicy garlic tomato sauce with chicken', ingredients: ['Penne Pasta', 'Chicken', 'Spicy Tomato Sauce', 'Garlic', 'Chili Flakes'] },
    { name: 'Spaghetti Carbonara', category: 'Pasta', description: 'Classic spaghetti in velvety cream, egg yolk, cheese and bacon/ham sauce', ingredients: ['Spaghetti', 'Cream', 'Egg Yolk', 'Cheese', 'Black Pepper'] },
    { name: 'Penne Alfredo with Prawns', category: 'Pasta', description: 'Creamy parmesan Alfredo sauce penne with succulent sautéed prawns', ingredients: ['Penne Pasta', 'Prawns', 'Alfredo Cream Sauce', 'Parmesan Cheese'] },
    ...
    // ── Macaroni ──────────────────────────────────────────────────────────────
    { name: 'Cheese Macaroni (Sri Lankan Style)', category: 'Macaroni', description: 'Sri Lankan style spiced macaroni loaded with melted cheese', ingredients: ['Macaroni', 'Cheese', 'Curry Spices', 'Onions', 'Chili'] },
    { name: 'Chicken Macaroni (Sri Lankan Style)', category: 'Macaroni', description: 'Sri Lankan style spiced macaroni stir-fried with chicken', ingredients: ['Macaroni', 'Chicken', 'Curry Spices', 'Onions', 'Tomatoes'] },
    { name: 'Seafood Macaroni (Sri Lankan Style)', category: 'Macaroni', description: 'Spicy macaroni stir-fried with prawns and cuttlefish', ingredients: ['Macaroni', 'Prawns', 'Cuttlefish', 'Curry Spices', 'Capsicum'] },
    { name: 'Mixed Macaroni (Sri Lankan Style)', category: 'Macaroni', description: 'Spicy Sri Lankan macaroni stir-fried with chicken, seafood and egg', ingredients: ['Macaroni', 'Chicken', 'Seafood', 'Egg', 'Spices'] },

    // ── Fish ──────────────────────────────────────────────────────────────────
    { name: 'Devilled or Chili Fish', category: 'Fish', description: 'Fried fish cubes stir-fried with capsicum, onions and fiery chili sauce', ingredients: ['Fish Fillets', 'Capsicum', 'Onions', 'Devilled Sauce'] },
    { name: 'Stew or Curry Fish', category: 'Fish', description: 'Fresh fish fillets simmered in coconut milk curry or delicate stew', ingredients: ['Fish', 'Coconut Milk', 'Turmeric', 'Fenugreek', 'Curry leaves'] },
    { name: 'Fried Fish', category: 'Fish', description: 'Crispy seasoned whole fried fish fillets', ingredients: ['Fish Fillets', 'Turmeric', 'Chili powder', 'Salt'] },
    { name: 'Boiled Fish', category: 'Fish', description: 'Healthy fresh fish fillets boiled with herbs and pepper', ingredients: ['Fish', 'Pepper', 'Salt', 'Herb broth'] },
    { name: 'Fish Finger', category: 'Fish', description: 'Golden crumbed fish fillets served with dipping sauce', ingredients: ['Fish Fillets', 'Breadcrumbs', 'Egg wash', 'Tartar sauce'] },

    // ── Pork ──────────────────────────────────────────────────────────────────
    { name: 'Devilled Pork', category: 'Pork', description: 'Tender pork cubes tossed with tomatoes, capsicum and spicy devilled sauce', ingredients: ['Pork', 'Capsicum', 'Onion', 'Spicy Devilled Sauce'] },
    { name: 'Stew or Curry or Chili Pork', category: 'Pork', description: 'Slow-cooked flavorful pork in rich curry spices or chili stew', ingredients: ['Pork', 'Chili', 'Curry Spices', 'Garlic', 'Ginger'] },
    { name: 'Fried Pork', category: 'Pork', description: 'Deep fried crispy seasoned pork pieces', ingredients: ['Pork', 'Black pepper', 'House seasoning'] },
    { name: 'Black Pepper Pork', category: 'Pork', description: 'Succulent pork pieces tossed in crushed black pepper and caramelized onions', ingredients: ['Pork', 'Crushed Black Pepper', 'Caramelized Onions', 'Soy sauce'] },

    // ── Octopus ───────────────────────────────────────────────────────────────
    { name: 'Stew Octopus (Sri Lankan Style)', category: 'Octopus', description: 'Tender octopus braised in mild aromatic Sri Lankan style stew with vegetables', ingredients: ['Octopus', 'Potatoes', 'Carrots', 'Black Pepper', 'Onions'] },
    { name: 'Curry Octopus (Sri Lankan Style)', category: 'Octopus', description: 'Slow cooked spicy octopus curry in roasted spices and coconut gravy', ingredients: ['Octopus', 'Roasted Curry Powder', 'Coconut Milk', 'Garlic', 'Goraka'] },
    { name: 'Boiled Octopus with Salad', category: 'Octopus', description: 'Tender boiled octopus seasoned and served alongside fresh garden salad', ingredients: ['Boiled Octopus', 'Lettuce', 'Cucumber', 'Tomato Salad', 'Lemon Vinaigrette'] },

    // ── Chicken ───────────────────────────────────────────────────────────────
    { name: 'Devilled or Chili Chicken', category: 'Chicken', description: 'Crispy fried chicken tossed in sweet, spicy and tangy devilled chili sauce', ingredients: ['Chicken', 'Capsicum', 'Onions', 'Devilled Chilli Sauce'] },
    { name: 'Stew or Curry Chicken', category: 'Chicken', description: 'Tender chicken slow cooked in rich Sri Lankan aromatic curry or stew gravy', ingredients: ['Chicken', 'Coconut milk', 'Curry spices', 'Curry leaves'] },
    { name: 'Fried Chicken', category: 'Chicken', description: 'Golden crispy deep-fried chicken portions seasoned with house spices', ingredients: ['Chicken', 'Spiced Flour Batter', 'Crispy Coating'] },
    { name: 'Hot Batter Chicken', category: 'Chicken', description: 'Bite-sized chicken fried in crispy hot batter tossed in spicy chili butter', ingredients: ['Chicken', 'Crispy Batter', 'Chili Flakes', 'Garlic Butter'] },
    { name: 'Batter Garlic Chicken', category: 'Chicken', description: 'Crispy batter-fried chicken infused with rich aromatic garlic sauce', ingredients: ['Chicken', 'Garlic', 'Batter', 'Spring Onions'] },
    { name: 'Chicken Curry', category: 'Chicken', description: 'Traditional homestyle spicy chicken curry with thick gravy', ingredients: ['Chicken', 'Roasted Curry Powder', 'Garlic', 'Pandan Leaves'] },
  ];
